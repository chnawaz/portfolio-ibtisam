    ...
    <>
      <div className="max-w-[1336px]  gap-[80px] flex flex-col m-auto px-8">
        ...
        <div className="w-full  gap-[48px] flex flex-col ">
          {/* pic div start */}
          <div className="w-full gap-[24px] flex  flex-row ">
            <img src={person} className=" object-cover w-[30%]" alt="" />
          ...
          <div className="w-full gap-[24px] flex mt-[48px]">
            ...
            <div className=" flex flex-col justify-between w-[50%]">
              <p className="font-[500] text-[24px] leading-[150%] tracking-[0%] text-slate-700 ">
              ...
              <p className="font-[500] text-[24px] leading-[130%] tracking-[0%] text-slate-700">
